...
See string_methods.py line 18 for an example.  
...
```py
line = 'Please be nice to her.'
line.startswith('Please') # True
line.startswith('nice')   # False
line.startswith('please') # False
```

### Parsing & Extracting

```py
data = 'from stephen.hawking@ucla.mit.fake Sat Jun 16 08:32:28 2016'
atpos = data.find('@')
print(atpos) # 20
sppos = data.find(' ',atpos) # find the first space after @
print(sppos) # 34
host = data[atpos+1:sppos]
print(host) # ucla.mit.fake
```
---
EOF